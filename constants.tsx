...
export const BriefcaseIcon: React.FC<IconProps> = ({ className="w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25v-4.07M20.25 14.15v-4.87a2.25 2.25 0 00-2.25-2.25h-12a2.25 2.25 0 00-2.25 2.25v4.87M20.25 14.15L16.5 13.5M4.5 14.15L8.25 13.5m0 0L12 12m4.5 1.5l-4.5-1.5m0 0l-4.5 1.5M12 12v9" />
    </svg>
);
